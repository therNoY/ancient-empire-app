<template>
	<view :class="[
      ...
      'uni-tag--' + size
    ]" @click="onClick()" class="uni-tag">
		<text :class="[type === 'default' ? 'uni-tag--default':'uni-tag-text',inverted === true || inverted === 'true' ? 'uni-tag-text--'+type : '',size === 'small' ? 'uni-tag-text--small':'' ]">
			<slot></slot>
		</text>
	</view>
</template>
